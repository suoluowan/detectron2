...
def add_poisenet_config(cfg: CN):

    _C = cfg
    _C.MODEL.POISENET = CN()
    _C.MODEL.POISENET.BLOCK_FPATH = ""
    _C.MODEL.POISENET.BLOCK_NUM = 5
    _C.MODEL.POISENET.POISE_CLS_WEIGHTS = 0.0005
    _C.MODEL.POISENET.POISE_REGRESSION_WEIGHTS = 0.02
    _C.MODEL.POISENET.PART_LOSS_TYPE = "SCE" # "AEQL"
    _C.MODEL.POISENET.FREQ_CLASSES = None
