...
class PoiseNetPredictor(nn.Module):
    ...
    def __init__(self, cfg: CfgNode, input_channels: int):
        ...
        dim_out_patches_i = cfg.MODEL.ROI_DENSEPOSE_HEAD.NUM_PATCHES + 1
        dim_out_patches_uv = cfg.MODEL.ROI_DENSEPOSE_HEAD.NUM_PATCHES * cfg.MODEL.POISENET.BLOCK_NUM
        ...
        self.index_uv_lowres = ConvTranspose2d(
            dim_in, dim_out_patches_i, kernel_size, stride=2, padding=int(kernel_size / 2 - 1)
        )
        # U
