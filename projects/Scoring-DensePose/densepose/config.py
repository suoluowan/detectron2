...
def add_densepose_head_scoring_config(cfg: CN):
    _C = cfg
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING_ON = False
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING = CN()
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.NAME = ""
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.PREDICTOR_NAME = "DensePoseScoringPredictor"
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.LOSS_NAME = "DensePoseScoringLoss"
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.HIDDEN_DIM = 256
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.NUM_STACKED_FCS = 2
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.LOSS_WEIGHT = 1.0
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.LOSS_WEIGHT_POINT = 1.0
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.NUM_STACKED_CONVS = 2
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.CONV_HEAD_KERNEL = 3
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.POOLER_RESOLUTION = 1
    _C.MODEL.ROI_DENSEPOSE_HEAD.SCORING.SCORING_CLS_NUM = 1
...
def add_densepose_head_config(cfg: CN):
    ...
    add_densepose_head_scoring_config(cfg)
